...
@constraint(diet, constraint1, 7pb + 7wmlk + 12oats + 26beef >= 160)
@constraint(diet, constraint2, 16pb + 4wmlk + 6oats + 12beef <= 80)
# @constraint(diet, constraint3, 2pb + 9oats <= 25) 
@constraint(diet, constraint4, 3pb + 6wmlk <= 40)


#=
@constraint(diet, constraint1, 7pb + 8wmlk + 12oats + 24.19beef >= 160)
@constraint(diet, constraint2, 16pb + 8wmlk + 6oats + 5.6beef <= 80)
...
println("\nprotein: ", value(7pb + 7wmlk + 12oats + 26beef))
println("fat: ", value(16pb + 4wmlk + 6oats + 12beef))
println("fiber: ", value(2pb + wmlk + 9oats))
println("sugar: ", value(3pb + 6wmlk))